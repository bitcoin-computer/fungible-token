    ...
    : <LoginScreen>
        <div id="">
          <div className="module center padding-left-24">
            ...
            <small><a target="_blank" rel="noopener noreferrer" href='https://iancoleman.io/bip39/'>Generate BIP39 Seed</a></small><br />
            <form onSubmit={login}>
            <input className="textbox" placeholder='Password (BIP39 Seed)' type="string" value={password} onChange={(e) => setPassword(e.target.value)} />
